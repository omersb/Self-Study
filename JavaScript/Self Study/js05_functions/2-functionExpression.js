...
//* Örnek2: Parametreli, Dönüş değerli
//***************************************************************/

// console.log(tekCift(5)); 
//!funcion expression yöntemiyle bir fnk tanımlandığında önce tanımlamanın yapılaması gerekir yoksa Uncaught ReferenceError: Connot access 'tekCift' before intirialization hatası alınır.

const tekCift = function (number) {
    return number % 2 === 0 ? `${number} çiftir` : `${number} tekdir`;
};
console.log(tekCift(2));

//* Örnek3: 3 sayının en büyüğünü bulun fonks.
//***************************************************************/
